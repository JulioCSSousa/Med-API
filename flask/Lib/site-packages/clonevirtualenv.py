...
def fixup_script_(root, file_, old_dir, new_dir, version,
    ...
    # '#!/flask/bin/python3' while the version of system python
...
def main():
    parser = optparse.OptionParser("usage: %prog [options]"
        " /path/to/existing/flask /path/to/cloned/flask")
    parser.add_option('-v',
            action="count",
            dest='verbose',
            default=False,
