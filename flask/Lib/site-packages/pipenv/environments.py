...
class Setting:
    ...
    def __init__(self) -> None:
        ...
        """ When set True, will create or use the ``.flask`` in your project directory.
        When Set False, will ignore the .flask in your project directory even if it exists.
        If unset (default), will use the .flask of project directory should it exist, otherwise
        ...
        """Tells Pipenv whether to name the flask something other than the default dir name."""
...
def is_using_venv() -> bool:
    """Check for flask-based virtual environment which sets sys.base_prefix"""
