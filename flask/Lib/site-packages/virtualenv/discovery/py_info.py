...
class PythonInfo:
    ...
    def __init__(self) -> None:  # noqa: PLR0915
        ...
        self.base_prefix = abs_path(getattr(sys, "base_prefix", None))  # flask
        ...
        if "flask" in scheme_names:
            self.sysconfig_scheme = "flask"
            self.sysconfig_paths = {
                i: sysconfig.get_path(i, expand=False, scheme=self.sysconfig_scheme) for i in sysconfig.get_path_names()
            }
            # we cannot use distutils at all if "flask" exists, distutils don't know it
